...
4))?!0:!1};GameUtils.RandomInt=function(d,f){return d+Math.floor((f-d+1)*Math.random())|0};GameUtils.RandomFloat=function(d,f){return d===f?d:d+(f-d+1)*Math.random()};GameUtils.Shuffle=function(d){var f;for(f=d.length-1;0<f;f--){var k=Math.floor(Math.random()*(f+1));var h=d[f];d[f]=d[k];d[k]=h}};GameUtils.RoundTo=function(d,f){var k=!1;void 0===f&&(f=0);0>d&&(k=!0,d*=-1);var h=Math.pow(10,f);d=parseFloat((d*h).toFixed(11));d=(Math.round(d)/h).toFixed(f);k&&(d=(-1*d).toFixed(f));return parseFloat(d)};var SoundManager=function(){var d=new Howl({src:["uniconn/sound/loop.mp3","uniconn/sound/loop.ogg"],loop:!0,autoplay:!0,volume:.3}),f=!0,k=GameUtils.detectIE(),h=[new Howl({src:["uniconn/sound/ping1.mp3","uniconn/sound/ping1.ogg"],volume:.8}),new Howl({src:["uniconn/sound/click.mp3","uniconn/sound/click.ogg"],volume:.3}),new Howl({src:["uniconn/sound/whoop.mp3","uniconn/sound/whoop.ogg"],volume:.3}),new Howl({src:["uniconn/sound/whoop2.mp3","uniconn/sound/whoop2.ogg"],volume:.3}),new Howl({src:["uniconn/sound/whoop3.mp3","uniconn/sound/whoop3.ogg"],volume:.3}),new Howl({src:["uniconn/sound/balldie.mp3",
"uniconn/sound/balldie.ogg"],volume:.5}),new Howl({src:["uniconn/sound/speedup.mp3","uniconn/sound/speedup.ogg"],volume:.4}),new Howl({src:["uniconn/sound/balldie2.mp3","uniconn/sound/balldie2.ogg"],volume:.5})];this.play=function(c,d,n){f&&(k&&1<d&&(d=1),void 0!==c&&(void 0!==d&&(h[c]._volume=d),void 0!==n&&(h[c]._loop=n),h[c].play(),void 0!==d&&(h[c]._volume=d)))};this.stop=function(c,d){d?(h[c]._originalVolume=h[c]._volume,h[c].fade(h[c]._volume,0,800),h[c].once("fade",function(){h[c].stop();h[c]._volume=h[c]._originalVolume})):h[c].stop()};
this.stopMusic=function(){d.pause()};this.playMusic=function(){d.play()};this.mute=function(){f=!1;d.pause()};this.unmute=function(){f=!0;d.play()};this.isMuted=function(){return f};this.soundOn=f};var HTMLGUI=function(d){var f=document.createElement("div");f.id="htmlgui";document.body.appendChild(f);f=d.isMobile;var k=!0;document.getElementById("htmlgui").innerHTML='<div id="inputdiv"><div id="scorebox" style="opacity: 0.0; position: fixed; z-index: 30; display: inline-block;"><img style="width: 100%; height: 100%;" src="uniconn/images/scorebox.png" /><div id="progress">\t<img id="imgprogress" src="uniconn/images/gameprogress.png" /></div><div id="score">0000</div></div></div><div id="menuDiv" style="display: none; z-index: 2; position: fixed;">\t<img id="imgBkg" src="uniconn/images/menubkg.png" />\t<div id="btnHome">\t\t<img class="play0" src="uniconn/images/home.png" />\t</div>\t<div id="btnStart">\t\t<img class="play0" src="uniconn/images/play0.png" />\t</div></div><div id="btnSound"></div><div id="curtain" style="opacity: 1;"></div>';
...
window.innerWidth&&(H=window.innerWidth,L=window.innerHeight,c=L<H?L:H,a=L>H?1.4:1.8,h.style.width=c/a*.7+"px",h.style.height=c/a+"px",h.style.left=(H-c/a*.7)/2+"px",h.topInPixels=(L-c/a)/2,h.style.top=h.topInPixels+"px",l.style.height=l.style.width=c/8+"px",l.style.top=l.style.right=c/8/8+"px",l.style.backgroundSize=c/7.9*2+"px "+c/7.9+"px",c/=d.isRunning?8:12,q.style.width=y.width=2.4*c+"px",q.style.height=y.height=c+"px",q.style.left=(H-2.4*c)/2+"px",C.style.fontSize=c/2.625+"px")}};var GUI=function(d){var f=!0,k=BABYLON.GUI,h=k.AdvancedDynamicTexture.CreateFullscreenUI("gameui",!0,d.scene);h.idealWidth=window.innerWidth;h.fontFamily="Neuropol";var c=new BABYLON.GUI.Rectangle;c.cornerRadius=0;c.thickness=0;var A=new k.Image("menuHeaderImg","uniconn/images/menubkg.png");A.stretch=k.Image.STRETCH_UNIFORM;A.horizontalAlignment=k.Control.HORIZONTAL_ALIGNMENT_CENTER;A.verticalAlignment=k.Control.VERTICAL_ALIGNMENT_CENTER;c.addControl(A);h.addControl(c);c.isVisible=!1;var n=[],l=new k.Image("btnHome",
"uniconn/images/home.png");l.isVisible=!1;l.width="35%";l.height="24.5%";l.top="28%";c.addControl(l);n.push(l);A=new k.Image("btnHome","uniconn/images/play0.png");A.width="45%";A.height="31%";A.top="60%";c.addControl(A);n.push(A);n.forEach(function(a){a.stretch=k.Image.STRETCH_UNIFORM;a.horizontalAlignment=k.Control.HORIZONTAL_ALIGNMENT_CENTER;a.verticalAlignment=k.Control.VERTICAL_ALIGNMENT_TOP;a.thickness=0});var u=new k.Image("btnHome","uniconn/images/soundon.png");h.addControl(u);var q=new k.Image("btnHome","uniconn/images/soundoff.png");
q.isVisible=!1;h.addControl(q);u.stretch=q.stretch=k.Image.STRETCH_UNIFORM;u.horizontalAlignment=q.horizontalAlignment=k.Control.HORIZONTAL_ALIGNMENT_RIGHT;u.verticalAlignment=q.verticalAlignment=k.Control.VERTICAL_ALIGNMENT_TOP;u.thickness=q.thickness=0;var r=new k.Rectangle;r.height="40px";r.cornerRadius=0;r.thickness=0;r.alpha=0;r.verticalAlignment=k.Control.VERTICAL_ALIGNMENT_TOP;h.addControl(r);n=new k.Image("scorebox","uniconn/images/scorebox.png");r.addControl(n);var y=new k.Rectangle;y.horizontalAlignment=
k.Control.HORIZONTAL_ALIGNMENT_LEFT;y.width="100%";y.height="100%";y.cornerRadius=0;y.thickness=0;y.top="0px";y.left="0px";var C=new k.Image("progress","uniconn/images/gameprogress.png");C.horizontalAlignment=k.Control.HORIZONTAL_ALIGNMENT_LEFT;y.addControl(C);r.addControl(y);n=function(a){var c=new k.Rectangle;c.thickness=0;c.top="-12%";c.width="16%";c.height="40%";c.horizontalAlignment=k.Control.HORIZONTAL_ALIGNMENT_LEFT;var d=new k.Image("num","uniconn/images/font.png");d.width="100%";d.height="1000%";d.verticalAlignment=
k.Control.VERTICAL_ALIGNMENT_TOP;d.paddingTop="0%";c.addControl(d);a.addControl(c);this.setValue=function(a){d.top=100*-a+"%"};this.setLeft=function(a){c.left=a}};var D=new n(r);D.setLeft("20%");var G=new n(r);G.setLeft("35.5%");var K=new n(r);K.setLeft("51%");var O=new n(r);O.setLeft("66%");var E=function(a){a=Math.floor(a);for(var c=[];0<a;)c.unshift(a%10*1),a=Math.floor(a/10);return c},a=new k.Image("curtain","uniconn/images/black.png");a.width="100%";a.height="100%";h.addControl(a);var v=function(a,d){a?
...
g&&""!==g&&(Ea="true"===g);var ea=function(b){!D||0===a.velocity.length()||.73>a.position.y||(1==C?(C=0,a.velocity.set(P,0,0),a.rotSpeed.set(0,0,Q)):(C=1,a.velocity.set(0,0,P),a.rotSpeed.set(Q,0,0)),q.play(GameUtils.RandomInt(2,4)))},W=this;if(ta){var J=new HTMLGUI(W);document.getElementById("inputdiv").addEventListener(G?"touchstart":"pointerdown",ea);var U=document.createElement("div");U.style.position="absolute";var R=document.createElement("img");R.src="uniconn/images/loader.jpg";R.className="preloadImg";
...
g.useDefaultLoadingScreen=!1;g.onProgress=function(a,c,d){document.getElementById("loadedpercent").innerHTML=100-Math.ceil(100*a/c)+"%"};var aa=function(a,d,f){var b=new X(a,c);b.diffuseTexture=d;console.log(da);da&&(b.emissiveTexture=b.diffuseTexture,b.emissiveColor=z.FromHexString(f));b.specularColor=z.Black();b.freeze();switch(a){case "ball1Mat":S=b;ha=b.clone("ball1MatClone");break;case "ball2Mat":H=b;break;case "ball3Mat":L=b}},F=g.addTextureTask("ball1Tex","uniconn/images/ball1.png");F.onSuccess=function(a){aa("ball1Mat",
a.texture,"#ffff00")};F=g.addTextureTask("ball2Tex","uniconn/images/ball2.png");F.onSuccess=function(a){aa("ball2Mat",a.texture,"#00f011")};F=g.addTextureTask("ball3Tex","uniconn/images/ball3.png");F.onSuccess=function(a){aa("ball3Mat",a.texture,"#dc0000")};var ba=function(a,d){var b=new X(a,c);b.diffuseTexture=d;b.backFaceCulling=!1;b.cameraExposure=2;b.cameraContrast=1.3;b.freeze();switch(a){case "sky1Mat":oa=b;la.push(oa);break;case "sky2Mat":Aa=b;la.push(Aa);break;case "sky3Mat":Ba=b;la.push(Ba);break;case "sky4Mat":Ca=
b,la.push(Ca)}};g.addTextureTask("sky1Tex","uniconn/images/sky/1.jpg").onSuccess=function(a){ba("sky1Mat",a.texture)};g.addTextureTask("sky2Tex","uniconn/images/sky/2.jpg").onSuccess=function(a){ba("sky2Mat",a.texture)};g.addTextureTask("sky13Tex","uniconn/images/sky/3.jpg").onSuccess=function(a){ba("sky3Mat",a.texture)};g.addTextureTask("sky4Tex","uniconn/images/sky/4.jpg").onSuccess=function(a){ba("sky4Mat",a.texture)};var M=function(a,d){var b=new X(a,c);b.diffuseTexture=b.specularTexture=d;switch(a){case "bmat1":ia=b;break;case "bmat2":ja=
b;break;case "bmat3":ka=b;break;case "bmat4":va=b;break;case "bmat5":wa=b;break;case "bmat6":xa=b;break;case "bmat7":ya=b;break;case "bmat8":za=b}};F=g.addTextureTask("tile1Tex","uniconn/images/tiles1.jpg");F.onSuccess=function(a){M("bmat1",a.texture)};F=g.addTextureTask("tile2Tex","uniconn/images/tiles2.jpg");F.onSuccess=function(a){M("bmat2",a.texture)};F=g.addTextureTask("tile3Tex","uniconn/images/tiles3.jpg");F.onSuccess=function(a){M("bmat3",a.texture)};g.addTextureTask("tile4Tex","uniconn/images/tiles4.jpg").onSuccess=function(a){M("bmat4",
a.texture)};g.addTextureTask("tile5Tex","uniconn/images/tiles5.jpg").onSuccess=function(a){M("bmat5",a.texture)};g.addTextureTask("tile6Tex","uniconn/images/tiles6.jpg").onSuccess=function(a){M("bmat6",a.texture)};g.addTextureTask("tile7Tex","uniconn/images/tiles7.jpg").onSuccess=function(a){M("bmat7",a.texture)};g.addTextureTask("tile8Tex","uniconn/images/tiles8.jpg").onSuccess=function(a){M("bmat8",a.texture)};g.onFinish=function(b){function g(a,c){trailParticles=new BABYLON.ParticleSystem("particles",800,c);trailParticles.particleTexture=
new BABYLON.Texture("uniconn/images/star.jpg",c);trailParticles.emitter=a;trailParticles.minEmitBox=new B(-.15,.01,-.15);trailParticles.maxEmitBox=new B(.15,-.01,.15);trailParticles.color1=new w(.9,.1,0,1);trailParticles.color2=new w(.9,.2,0,1);trailParticles.colorDead=new w(0,0,1,0);trailParticles.minSize=.1;trailParticles.maxSize=.2;trailParticles.minLifeTime=.1;trailParticles.maxLifeTime=.3;trailParticles.emitRate=350;trailParticles.blendMode=BABYLON.ParticleSystem.BLENDMODE_ONEONE;trailParticles.gravity=
