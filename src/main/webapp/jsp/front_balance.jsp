...
<div class="page">
    ...
    <section class="section section-sm bg-default bg_second_cl">
        ...
        <div id="div_tableintegel" style="margin: 0 auto">
            <div>
                <div>  <span>截止
                    <a id="balance_time">2019年8月28日</a>
                    ：</span></div>
                ...
                <div id="cent" style="text-align:center">
                    ...
                    <div>
                        <span style="color:orangered;font-size:25px;">
                            <a id="balance_residue">69</a>元  <%--//余额--%>
                        </span>
                    </div>
                </div>
                <div> <span>实时话费：</span>
                    <span style="color:orangered;font-size:15px;">
                        <a id="balance_expenditure">46.2</a>元    <%--消费--%>
                    </span>
                ...
                <div> <span>账户余额：</span>
                    <span style="color:orangered;font-size:15px;">
                        <a id="balance_all">47.2</a>元    <%--总余额--%>
                    </span>
                </div>
                <hr/>
                <div> <span>可用预存款：</span>
                    <span style="color:orangered;font-size:15px;">
                        <a id="balance_prestore">91.2</a>元  <%--预存金额--%>
                    </span>
                </div>
            </div>
            <p></p>
