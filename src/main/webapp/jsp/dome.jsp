...
<!-- 				<div style="position:absolute; right:30px; top:14px;">
				...
				<span class="pull-right" style="padding-right:3%;"><a href="javascript:changepage(1);" class="btn btn-success">短信验证登陆</a></span>
				<span class="pull-right" style="padding-right:3%;"><a href="javascript:changepage(1);" class="btn btn-success">识别登陆</a></span>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr"> © 传一科技 2019</span></font>
				</div>
			</div>
		</div>
		</div>
		...
		<div id="loginbox2">
			<form action="" method="post" name="loginForm" id="loginForm2">
<!-- 					<div style="position:absolute; right:30px; top:14px;">
					<a href="javascript:;" target="_blank">账号注册
					<em style="width:16px; height:16px; background:#999; float:right; color:#fff; border-radius:100%; text-align:center; line-height:16px; margin:1px 0 0 5px; font-family:'宋体'; font-weight:bold;">&gt;</em>
					</a>
				</div> -->
				<span class="pull-right" style="padding-right:3%;"><a href="javascript:changepage(2);" class="btn btn-success">普通登陆</a></span>
						<span class="pull-right" style="padding-right:3%;"><a href="javascript:changepage(2);" class="btn btn-success">识别登陆</a></span>
				<div class="control-group normal_text">
					<h3>
						<img src="static/login/logo.png" alt="Logo" />
					</h3>
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							<span class="add-on bg_lg">
							<i>验证码</i>
							</span><input type="text" name="EMAIL" id="EMAIL" value="" placeholder="短信验证码" />					
									<input  type="button" id="btn"  value="获取动态密码" onclick="Sendpwd(this)" />
...
<!-- 
						...
						<span class="pull-right"><a onclick="register();" class="flip-link btn btn-info" id="to-recover2">提交</a></span>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr2"> © 传一科技 2019</span></font>
				</div>
			</div>
		</div>
		</div>
