...
<div class="login_wrap" style="width:; background:#fff url(<%=path+"/index/images/20161209115754_5628.jpg"%>) no-repeat center top; padding:40px 0;">
        ...
        <div class="login_border" style="padding:8px;">
            <div class="login" style="display: block;">
                ...
                <div class="login-body">
                    <form action="login/login.action" method="post" id="oneform">
                    <div class="login-style" style="display: block;">
                        <dl><dd><input type="text" id="PHONECARDNUMBER" name="PHONECARDNUMBER1" placeholder="用户名/邮箱/手机号" /></dd></dl>
                        <dl>
                            <dd><input type="password" id="PHONECARDPASSWORD" name="PHONECARDPASSWORD1" placeholder="请输入您的密码" /></dd>
                        </dl>
                        ...
                        <div class="tishi"></div>
                        <input type="button" onclick="aa()" id="logbtn" style="outline:none" value="登 录"/>
                    </div>
                    </form>

                    <div class="login-style">
                        <form action="login/loginn.action" method="post" id="twoform">
                        ...
                        <dl>
                            <dd><input type="text" id="Code" name="Code"  style="width: 133px;" placeholder="短信验证码" /><input type="button" id="btn" class="btn_mfyzm" value="获取动态密码" onclick="Sendpwd(this)" /></dd>
                        </dl>
                        <div class="remember">
                            <input type="checkbox" id="issave1" checked /><label for="issave1">下次自动登录</label>
                        </div>
                        <div class="tishi"></div>
                        <input type="button" onclick="subfrom()" id="dynamicLogon" style="outline:none"  value="登 录"/>
                        </form>
                        </div>
                ...
                <div id="zhishi" style="position:absolute; right:-185px; bottom:0; cursor:pointer;"><img src=<%=path+"index/images/zhishi2.png"%> /></div>
            </div>
